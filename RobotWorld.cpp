...
namespace Model
{
	...
	{
		RobotWorld::getRobotWorld().newRobot("Thomas", Point(152, 361), false);

		RobotWorld::getRobotWorld().newGoal("Thomas", Point(362, 134), false);
